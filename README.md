# PSPDFKit Document Engine Example – Rails

This example shows how to integrate PSPDFKit Document Engine and
...
The example is now running on [http://localhost:3000](http://localhost:3000). You can access the PSPDFKit Document Engine dashboard at [http://localhost:5000/dashboard](http://localhost:5000/dashboard) using `dashboard` // `secret`.

Upload a PDF via the button in the top-left, then click on the cover image to see PSPDFKit for Web in action.

## Using a license

If you have a PSPDFKit Document Engine license you can use it as well by going through the following steps:
...
- [PSPDFKit Document Engine](https://pspdfkit.com/getting-started/document-engine/)
