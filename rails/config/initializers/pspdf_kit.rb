...
# We need two config options for the PSPDFKit Document Engines URL, because one is called
...
#
PSPDFKit.configure(
  internal_url: ENV.fetch("PSPDFKIT_SERVER_INTERNAL_URL", "http://localhost:5000"),
  external_url: ENV.fetch("PSPDFKIT_SERVER_EXTERNAL_URL", "http://localhost:5000"),
  auth_token: "secret",
