...
module PSPDFKit
  ...
  def upload_document(path)
    # call the Nutrient Document Engine api endpoint "POST api/documents/" to upload a new document
  ...
  def delete_document(document)
    ...
    # When Nutrient Document Engine returns status code 200 OK delete the document from the database.
